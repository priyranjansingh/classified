...
<head>
    ...
    <title><?php echo translate(get_settings('site_settings', 'site_title', 'NuggPlug classified')); ?>
...
<body class="home fixed sticky-bar off-canvas-right" dir="rtl">
...
<body class="home fixed sticky-bar off-canvas-right" dir="<?php echo get_settings('site_settings','site_direction','ltr');?>">
