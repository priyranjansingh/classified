            ...
            <div class="col-md-9 col-sm-12 col-xs-12">
                ...
                <!-- Comments section -->
                    <div class="blog-comments">
                        <?php $comment_settings = get_settings('classified_settings', 'enable_comment', 'No'); ?>
                        <?php if($comment_settings == 'Disqus Comment'){ ?>
                            <?php $disqus_shortname = get_settings('classified_settings', 'disqus_shortname', 'nuggplug'); ?>
                        ...
                        <?php if($comment_settings == 'Facebook Comment'){ ?>
                            <?php $fb_app_id = get_settings('classified_settings', 'fb_comment_app_id', '1510845559191569'); ?>
