                    ...
                    ?>
                        <div class="row">
                                    ...
                                    <div class="col-md-9 col-sm-9 col-xs-12">
                                        ...
                                        <?php }?>
                                        <p class="contact-types">
                                            <strong><?php echo lang_key('phone'); ?>:</strong> <?php echo get_user_meta($user->id, 'phone'); ?> <strong><?php echo lang_key('email');?>:</strong> <a href="mailto:<?php echo $user->user_email; ?>"><?php echo $user->user_email; ?></a>
                                        </p>
                                        <!-- Social -->
                                        <div class="brand-bg">
