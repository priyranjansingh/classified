...
$status = json_decode(@file_get_contents(get_author_url().'admin/verify/checkversion/NuggPlug'));
   ...
   google.maps.event.addDomListener(window, 'load', initialize);
      ...
      <div class="page-title">
        ...
        <div>
          ...
          <h1><i class="fa fa-file-o"></i> <?php echo lang_key('dashboard');?> <div class="version"> NuggPlug Classified - version : <?php echo $config[0]->version;?></div></h1>
...
<div class="row">
              ...
              <div class="col-md-12">
                ...
                <div class="tile">
                  ...
                  <p class="title">
                    ...
                    NuggPlug Classifieds - Listing your classifieds

                  </p>

                  <p>

                    Buy and Sell your product easily
              ...
              <div class="col-md-12 tile-active">
                ...
                <div class="tile tile-blue">
                  ...
                  <p class="title">
                    ...
                    NuggPlug Classified Admin

                  </p>

                  <p>

                      NuggPlug Classified is the most complete and easy manageable Classifieds script
    ...
    <div class="row">
      <div class="col-md-12">
        <a href="//nuggplug.com" target="_blank" class="btn btn-info"><?php echo lang_key('see_full_documentation');?></a>
      </div>
    </div> 
<style type="text/css">
  .version{
