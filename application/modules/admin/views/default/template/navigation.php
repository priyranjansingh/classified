<div id="sidebar" class="navbar-collapse collapse">
    ...
    <ul class="nav nav-list">
        ...
        <li class="<?php echo is_active_menu('admin/classified/'); ?>">
            <a href="#" class="dropdown-toggle">
            ...
            <ul class="submenu">
                ...
                <li class="<?php echo is_active_menu('admin/classified/allposts'); ?>">
                    <a href="<?php echo site_url('admin/classified/allposts'); ?>">
                ...
                <li class="<?php echo is_active_menu('admin/classified/emailtracker'); ?>">
                    <a href="<?php echo site_url('admin/classified/emailtracker'); ?>">
                        <?php echo lang_key('email_tracker'); ?>
                    </a>
                </li>

                <li class="<?php echo is_active_menu('admin/classified/bulkemailform'); ?>">
                    <a href="<?php echo site_url('admin/classified/bulkemailform'); ?>">
                ...
                <li class="<?php echo is_active_menu('admin/classified/locations'); ?>">
                    <a href="<?php echo site_url('admin/classified/locations'); ?>">
                        <?php echo lang_key('locations'); ?>
                    </a>
                </li>

                <li class="<?php echo is_active_menu('admin/classified/classifiedsettings'); ?>">
                    <a href="<?php echo site_url('admin/classified/classifiedsettings'); ?>">
                        <?php echo lang_key('site_settings'); ?>
                    </a>
                </li>

                <li class="<?php echo is_active_menu('admin/classified/paypalsettings'); ?>">
                    <a href="<?php echo site_url('admin/classified/paypalsettings'); ?>">
                        <?php echo lang_key('paypal_settings'); ?>
                    </a>
                </li>

                <li class="<?php echo is_active_menu('admin/classified/payments'); ?>">
                    <a href="<?php echo site_url('admin/classified/payments'); ?>">
                        <?php echo lang_key('payment_history'); ?>
                    </a>
                </li>

                <li class="<?php echo is_active_menu('admin/classified/bannersettings'); ?>">
                    <a href="<?php echo site_url('admin/classified/bannersettings'); ?>">
