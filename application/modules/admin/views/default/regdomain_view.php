...
<head>
    ...
    <title>NuggPlug | Admin Panel</title>
...
<body>
  <?php //include 'template/theme_settings.php';?>
    <div class="container" id="main-container">
        <div class="domreg">
          <h4>Please register your NuggPlug with nuggplug</h4>
          <p>You need to register you copy of NuggPlug first with nuggplug.</p>
