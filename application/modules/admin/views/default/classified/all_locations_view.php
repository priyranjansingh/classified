...
<div class="row">
  ...
  <div class="col-md-12">
    ...
    <a href="<?php echo site_url('admin/classified/newlocation/country');?>" class="btn btn-success add-location"><?php echo lang_key('add_country');?></a>

      <?php if($state_active == 'yes'){ ?>
          <a href="<?php echo site_url('admin/classified/newlocation/state');?>" class="btn btn-info add-location"><?php echo lang_key('add_state');?></a>
      <?php } ?>

    <a href="<?php echo site_url('admin/classified/newlocation/city');?>" class="btn btn-warning add-location"><?php echo lang_key('add_city');?></a>
                  ...
                  <td data-title="<?php echo lang_key('actions');?>" class="numeric">
                    ...
                    <div class="btn-group">
                      ...
                      <ul class="dropdown-menu dropdown-info">
                          ...
                          <li><a href="<?php echo site_url('admin/classified/editlocation/'.$row->type.'/'.$row->id);?>" class="edit-location"><?php echo lang_key('edit');?></a></li>
                          <li><a href="<?php echo site_url('admin/classified/deletelocation/'.$curr_page.'/'.$row->id);?>"><?php echo lang_key('delete');?></a></li>
