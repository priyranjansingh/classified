                      ...
                      <?php if(is_admin()){?>
                        <?php if($row->is_active==2){?>
                            <?php if($row->payment_type=='post') {?>
                              <li><a href="<?php echo site_url('admin/classified/approveposttransaction/'.$row->unique_id);?>"><?php echo lang_key('approve');?></a></li>
                            <?php }?>
                            <?php if($row->payment_type=='post_renew') {?>
                              <li><a href="<?php echo site_url('admin/classified/approveposttransaction/'.$row->unique_id);?>"><?php echo lang_key('approve');?></a></li>
                            <?php }?>
                            <?php if($row->payment_type=='feature') {?>
                              <li><a href="<?php echo site_url('admin/classified/approvefeaturetransaction/'.$row->unique_id);?>"><?php echo lang_key('approve');?></a></li>
                            <?php }?>
                            <?php if($row->payment_type=='feature_renew') {?>
                              <li><a href="<?php echo site_url('admin/classified/approvefeaturerenewtransaction/'.$row->unique_id);?>"><?php echo lang_key('approve');?></a></li>
                            <?php }?>
                        <?php }?>
                          <li><a href="<?php echo site_url('admin/classified/deletetransaction/'.$row->unique_id);?>"><?php echo lang_key('delete');?></a></li>
                      <?php }?>
                      </ul>
