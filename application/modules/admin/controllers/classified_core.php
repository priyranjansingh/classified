...
class Classified_core extends MX_Controller {
	...
	{
		$value['posts']  	= $this->classified_model->get_all_post_based_on_user_type('all',$this->per_page,'create_time','desc');
	...
	public function locations($start='0')
	{
        ...
        $value['posts'] 	= $this->classified_model->get_all_locations_by_range($start,'id');
